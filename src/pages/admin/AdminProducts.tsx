        ...
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="card w-full max-w-lg max-h-[90vh] overflow-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                <label htmlFor="product-image" className="block text-sm font-medium text-foreground mb-1">
                  Image URL
                </label>
                <input
                  id="product-image"
              ...
              <div>
                <label htmlFor="product-affiliate" className="block text-sm font-medium text-foreground mb-1">
                  Affiliate URL
                </label>
                <input
